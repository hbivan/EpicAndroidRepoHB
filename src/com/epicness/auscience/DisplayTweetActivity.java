...
public class DisplayTweetActivity extends Activity {
    ...
    static final String TWITTER_CALLBACK_URL = "oauth://com.epicness.auscience";
...
//            AlertMessageBox.Show(DisplayTweetActivity.this, "Internet connection", "A valid internet connection can't be established", AlertMessageBox.AlertMessageBoxIcon.Info);
//            return;
//        }
//
...
//        	Log.e(TAG, "Either key or secret are null");
//        	AlertMessageBox.Show(DisplayTweetActivity.this, "Twitter oAuth infos", "Please set your twitter consumer key and consumer secret", AlertMessageBox.AlertMessageBoxIcon.Info);
//            return;
//        }
//
//        initialiseComponent();
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            alert.showAlertDialog(DisplayTweetActivity.this, "Internet Connection Error",
        ...
        if(TWITTER_CONSUMER_KEY.trim().length() == 0 || TWITTER_CONSUMER_SECRET.trim().length() == 0){
            // Internet Connection is not present
            alert.showAlertDialog(DisplayTweetActivity.this, "Twitter oAuth tokens", "Please set your twitter oauth tokens first!", false);
            // stop executing code by return
            return;
        }
...
//            builder.setOAuthAccessTokenSecret(TWITTER_ACCESS_TOKEN_SECRET);
                ...
                Thread thread = new Thread(new Runnable(){
                    ...
                    public void run() {
                        try {
                            ...
                            DisplayTweetActivity.this.startActivity(new Intent(Intent.ACTION_VIEW, Uri
    ...
    class updateTwitterStatus extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DisplayTweetActivity.this);
